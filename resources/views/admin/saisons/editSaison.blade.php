        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title">Modification d'une saison</h5>
                ...
                <div class="modal-body">
                    ...
                    <ul id="errorListUpdate"></ul>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control saison_up" name="" id="" placeholder="yyyy-yyyy">
...
<div class="modal fade" id="modalSup" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <form id="DelSaison">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title">Suppression d'une saison</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                <div class="modal-body">
                    <div class="container-fluid text-center">
                        <p>Êtes-vous sur de voiloire supprimer la saison <strong id="del_saison"></strong> ?</p>
